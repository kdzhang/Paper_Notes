##LASSO example (ridge is straightforward in this setting too)


load('/Users/justingrimmer/dropbox/teaching/text/tad14/class15/LASSO.RData')
...
final.pred<- ifelse(predict.probs>0.46, 1, 0) ## we determined this threshold via validation
